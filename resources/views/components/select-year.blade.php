...
>
    ...
    <button
        type="button"
        @click="open = !open"
        class="w-full text-sm border border-gray-300 bg-white p-2 flex justify-between items-center focus:border-blue-500 focus:shadow-lg focus:outline-none transition"
    >
        <span 
            class="truncate"
