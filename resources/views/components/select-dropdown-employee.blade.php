    ...
    <div @click.away="open = false; resetSearch()">
        ...
        <div class="relative">
            <input
                ...
                class="w-full text-sm border border-gray-300 bg-white px-3 py-2 pr-8 focus:border-[#2d326b] focus:ring focus:ring-[#2d326b] focus:ring-0 transition focus:border-blue-500 focus:shadow-lg focus:outline-none"
