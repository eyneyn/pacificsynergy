    ...
    <form action="" method="POST">
        ...
        <div class="bg-white rounded-sm border border-gray-200 p-6 shadow-md space-y-5 transition-all duration-300 hover:shadow-xl hover:border-[#E5E7EB]">
            ...
            <div class="space-y-5">
                ...
                <!-- PRODUCTION ACCESS (Manager Access) -->
                <div class="bg-gray-100 border border-gray-200 rounded-xl p-5 shadow-sm">
                    <div class="flex justify-between items-center mb-4">
                        <h4 class="text-sm font-semibold text-[#2d326b]">Production Access</h4>
                        <button type="button" @click="
                            form.permissions.dashboard = true;
                            form.permissions.productionreport_data = true;
                            form.permissions.edit_report = true;
                            form.permissions.delete_report = true;
                            form.permissions.analytics_report = true;
                            form.permissions.production_metrics = true;
                        " class="text-xs text-[#323B76] hover:underline">Enable all</button>
                    </div>
                    <div class="grid md:grid-cols-3 gap-4">
                        ...
                        <template x-for="[key, perm] in Object.entries({
                            ...
                            productionreport_data: {
                                label: 'Can add and view report.',
                                desc: 'This enables general access to create and view production report.'
                            },
                            edit_report: {
