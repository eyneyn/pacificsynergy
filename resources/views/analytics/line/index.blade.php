...
<h2 class="text-xl mt-6 mb-6 font-semibold text-[#2d326b] tracking-wider mb-4> text-center">PRODUCTION DOWNTIME ANALYSIS</h2>

<!-- Heading -->
<h2 class="text-lg font-semibold text-[#2d326b] tracking-wider mb-4">
    Production {{ $line ? 'Line ' . $line : 'Line Not Specified' }} (Year {{ request('date', now()->year) }})
</h2>
