            ...
            <form action="{{ route('configuration.standard.store') }}" method="POST">
                ...
                <div class="space-y-4 mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <!-- Size -->
                        <div class="flex items-center">
                            <label class="text-[#23527c] font-bold w-40 text-right mr-8" for="size">Size:</label>
                            <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <!-- Group -->
                        <div class="flex items-center">
                            <label class="text-[#23527c] font-bold w-40 text-right mr-8" for="group">Group:</label>
                            <div class="flex-1">
                                <x-select-dropdown name="group" id="group" required :options="['Water' => 'Water']" />
                                @error('group')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <!-- Preform Weight -->
                        <div class="flex items-center">
                            <label class="text-[#23527c] font-bold w-40 text-right mr-8" for="preform_weight">Preform Weight:</label>
                            <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <!-- Cases per Roll -->
                        <div class="flex items-center">
                            <label class="text-[#23527c] font-bold w-40 text-right mr-8" for="cases_per_roll">Cases per Roll:</label>
                            <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <!-- OPP Label -->
                        <div class="flex items-center">
                            <label class="text-[#23527c] font-bold w-40 text-right mr-8" for="opp_label">OPP Label:</label>
                            <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="flex items-center">
                            <label class="text-[#23527c] font-bold w-40 text-right mr-8" for="alt_preform_for_350ml">Alt Preform 350ml:</label>
                            <div class="flex-1">
        ...
        <div class="bg-[#5a9fd4] text-sm border border-[#4590ca] p-4 mt-4 text-white">
                ...
                <div class="flex gap-4 mt-4">
                    ...
                    <button type="submit" class="inline-flex items-center justify-center gap-1 bg-[#5bb75b] border border-[#43a143] text-white px-3 py-2 hover:bg-[#42a542] text-sm">
                        <x-icons-save class="w-2 h-2 text-white" /> Save
                    </button>
                </div>
            </form>
</div>
