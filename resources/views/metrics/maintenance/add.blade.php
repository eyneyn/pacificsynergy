...
<!-- Back Button -->
<a href="{{ url('metrics/maintenance/index') }}" class="flex items-center text-sm text-gray-500 hover:text-[#2d326b] mb-4">
...
<form action="{{ route('metrics.maintenance.store') }}" method="POST">
    @csrf

    <!-- Save Button -->
    <div class="mb-6 flex items-center justify-between">
        <div class="flex-1 text-center">
            <h2 class="text-xl font-bold text-[#2d326b]">New Maintenance</h2>
        </div>
    </div>
    ...
    <table class="w-full max-w-2xl text-sm border border-gray-200 shadow-sm">
        ...
        <tbody class="text-gray-700 divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-4 py-2">
                    <x-select-dropdown name="type" id="type" required
                            :options="[
                                'EPL' => 'EPL',
                                'OPL' => 'OPL',
                    ]" />
