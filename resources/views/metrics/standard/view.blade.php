...
<!-- Back Button -->
<a href="{{ route('metrics.standard.index') }}" class="flex items-center text-sm text-gray-500 hover:text-[#2d326b] mb-4">
...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex items-center gap-2">
        ...
        <form id="icon-delete-standard-form"
            ...
            action="{{ route('metrics.standard.destroy', $standard->id) }}"
            method="POST">
            @csrf
            @method('DELETE')
        ...
        <!-- Edit Button -->
        <a href="{{ route('metrics.standard.edit', $standard->id) }}"
...
<!-- Table Layout -->
<div class="overflow-x-auto bg-white rounded-sm border border-gray-200 p-6 shadow-md">
