...
<!-- Back Button -->
<a href="{{ route('metrics.defect.index') }}" class="flex items-center text-sm text-gray-500 hover:text-[#2d326b] mb-4">
...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex items-center gap-2">
        ...
        <form id="icon-delete-defect-form"
            ...
            action="{{ route('metrics.defect.destroy', $defect->id) }}"
            method="POST">
            @csrf
            @method('DELETE')
        ...
        <!-- Edit Button -->
        <a href="{{ route('metrics.defect.edit', $defect->id) }}"
    ...
    <!-- Table Layout -->
        <table class="w-full max-w-2xl text-sm border border-gray-200 shadow-sm">
            ...
            <tr>
                <th class="text-left px-4 py-3 w-1/4">Product Defect Field</th>
