...
<!-- Back Button -->
<a href="{{ route('metrics.defect.view', $defect->id) }}" class="flex items-center text-sm text-gray-500 hover:text-[#2d326b] mb-4">
...
<form action="{{ route('metrics.defect.update', $defect->id) }}" method="POST">
@csrf
@method('PUT')
        ...
        <table class="w-full max-w-2xl text-sm border border-gray-200 shadow-sm">
            ...
            <tbody class="text-gray-700 divide-y divide-gray-200">
                <tr>
                    ...
                    <td class="px-4 py-2">
                        <input type="text" name="defect_name" value="{{ old('defect_name', $defect->defect_name) }}"
                ...
                <tr>
                    ...
                    <td class="px-4 py-2">
                        <textarea name="description" id="description" rows="3"
                            class="w-full border border-gray-300 rounded px-3 py-1 text-sm">{{ old('description', $defect->description) }}</textarea>
